...
class ArucoFinder:
    def __init__(self , mode):
        ...
        self.prefix = rospy.get_param("/robot" , "")
        print(self.prefix)

        ###--- Subscriptores ---###
        rospy.Subscriber(self.prefix + "/fiducial_transforms", FiducialTransformArray, self.ft_cb)
        rospy.Subscriber(self.prefix + "/xarm_states", RobotMsg, self.rb_cb)
        ...
        while not rospy.is_shutdown():
            ...
            t.header.stamp = rospy.Time.now()
            t.header.frame_id = prefix + "tcp"
            t.child_frame_id = prefix + "usb_cam"
    ...
    def publish_transforms(self):
        ...
        t.child_frame_id = prefix + "pallet_1"
        ...
        t.header.stamp = rospy.Time.now()
        t.header.frame_id = "fiducial_707"
        t.child_frame_id = prefix + "pallet_2"
